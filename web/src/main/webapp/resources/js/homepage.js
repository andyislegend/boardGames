/*! BoardGames Exchange Project home page homepage.js
 * ================
 * Main JS application file for BoardGames Project. This file
 * should be included in all pages. It controls some layout
 * options.
 *
 * @Author  Andrii Petryk
 * @Email   <andrew.petryk@gmail.com>
 * @version 1.0.0
 */
function _init() {
    "use strict";
...
ga('send', 'pageview');
 ...
 /*
 * Created by andyislegend on 05.06.16.
 */
